    ...
    <circle cx="16.942" cy="20.834" r="308.334" stroke="#299253" strokeOpacity=".7" />
     ...
     <div className="min-h-screen bg-black text-white p-10 flex flex-col items-center ">
      ...
      <div className="flex space-x-6">
         <div
  className="mt-10 relative inline-block p-0.5 rounded-full overflow-hidden hover:scale-105 transition duration-300 active:scale-100 before:content-[''] before:absolute before:inset-0 before:bg-[conic-gradient(from_0deg,_#00F5FF,_#00F5FF30,_#00F5FF)] button-wrapper"
>
  <button
    className="relative z-10 bg-gray-800 text-white rounded-full  w-50 h-full item-center justify-center flex font-medium text-sm cursor-pointer gap-2 items-center"
    onClick={() => window.open(product.downloadLink, "_blank")}
  >
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#f6efef">
