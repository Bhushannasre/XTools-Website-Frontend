...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white flex items-center justify-center">
            <svg className="absolute inset-0 z-0 w-full h-full" viewBox="0 0 1440 720" fill="none" preserveAspectRatio="xMidYMid slice">
            ...
            >
                ...
                <p className="text-gray-400 text-sm mt-3 mb-11">
                    ...
                    <button
                        type="button"
                        onClick={() => { setState(prev => prev === "login" ? "register" : "login"); setError(null); }}
